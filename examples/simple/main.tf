module "subnet" {
  ...
  network_security_group_id = "/subscriptions/3136ec69-c7c7-4d73-ae13-44f44207a83f/resourcegroups/terraform-test/providers/Microsoft.Network/networkSecurityGroups/terraform-test-nsg"
}